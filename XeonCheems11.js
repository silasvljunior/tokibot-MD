                    ...
                    XeonBotInc.sendMessage(i, {
                        ...
                        contextInfo: {
                            externalAdReply: {
                                ...
                                thumbnailUrl: 'https://i.ibb.co/FX3xFdy/eu.jpg',
                                sourceUrl: wagc,
                                mediaType: 1,
                                renderLargerThumbnail: true
                            }
...
break
            ...
            break
            case 'runtime':
                let pinga = `O bot está em execução por ${runtime(process.uptime())}`
                XeonBotInc.sendMessage(m.chat, {
                    text: pinga,
                    contextInfo: {
                        externalAdReply: {
                ...
                break
case 'sc': case 'script': case 'donate': case 'donate': case 'cekupdate': case 'updatebot': case 'cekbot': case 'sourcecode': case 'canal':{
let me = m.sender
let teks = `*「  ${global.botname} 」*\n\nYouTube: ${global.websitex}\nGitHub: ${global.botscript}\n\nHi @${me.split('@')[0]} 👋para algum donate: https://i.ibb.co/Fgsf7zb/Whats-App-Image-2022-04-14-at-23-35-18.jpg`
